...
Music81:	binclude	"sound/MUSIC/music81.bin"
		even
Music82:	binclude	"sound/MUSIC/music82.bin"
		even
Music83:	binclude	"sound/MUSIC/music83.bin"
		even
Music84:	binclude	"sound/MUSIC/music84.bin"
		even
Music85:	binclude	"sound/MUSIC/music85.bin"
		even
Music86:	binclude	"sound/MUSIC/music86.bin"
		even
Music87:	binclude	"sound/MUSIC/music87.bin"
		even
Music88:	binclude	"sound/MUSIC/music88.bin"
		even
Music89:	binclude	"sound/MUSIC/music89.bin"
		even
Music8A:	binclude	"sound/MUSIC/music8A.bin"
		even
Music8B:	binclude	"sound/MUSIC/music8B.bin"
		even
Music8C:	binclude	"sound/MUSIC/music8C.bin"
		even
Music8D:	binclude	"sound/MUSIC/music8D.bin"
		even
Music8E:	binclude	"sound/MUSIC/music8E.bin"
		even
Music8F:	binclude	"sound/MUSIC/music8F.bin"
		even
Music90:	binclude	"sound/MUSIC/music90.bin"
		even
Music91:	binclude	"sound/MUSIC/music91.bin"
		even
Music92:	binclude	"sound/MUSIC/music92.bin"
		even
Music93:	binclude	"sound/MUSIC/music93.bin"
		even
; ---------------------------------------------------------------------------
...
SoundA0:	binclude	"sound/SFX/soundA0.bin"
		even
SoundA1:	binclude	"sound/SFX/soundA1.bin"
		even
SoundA2:	binclude	"sound/SFX/soundA2.bin"
		even
SoundA3:	binclude	"sound/SFX/soundA3.bin"
		even
SoundA4:	binclude	"sound/SFX/soundA4.bin"
		even
SoundA5:	binclude	"sound/SFX/soundA5.bin"
		even
SoundA6:	binclude	"sound/SFX/soundA6.bin"
		even
SoundA7:	binclude	"sound/SFX/soundA7.bin"
		even
SoundA8:	binclude	"sound/SFX/soundA8.bin"
		even
SoundA9:	binclude	"sound/SFX/soundA9.bin"
		even
SoundAA:	binclude	"sound/SFX/soundAA.bin"
		even
SoundAB:	binclude	"sound/SFX/soundAB.bin"
		even
SoundAC:	binclude	"sound/SFX/soundAC.bin"
		even
SoundAD:	binclude	"sound/SFX/soundAD.bin"
		even
SoundAE:	binclude	"sound/SFX/soundAE.bin"
		even
SoundAF:	binclude	"sound/SFX/soundAF.bin"
		even
SoundB0:	binclude	"sound/SFX/soundB0.bin"
		even
SoundB1:	binclude	"sound/SFX/soundB1.bin"
		even
SoundB2:	binclude	"sound/SFX/soundB2.bin"
		even
SoundB3:	binclude	"sound/SFX/soundB3.bin"
		even
SoundB4:	binclude	"sound/SFX/soundB4.bin"
		even
SoundB5:	binclude	"sound/SFX/soundB5.bin"
		even
SoundB6:	binclude	"sound/SFX/soundB6.bin"
		even
SoundB7:	binclude	"sound/SFX/soundB7.bin"
		even
SoundB8:	binclude	"sound/SFX/soundB8.bin"
		even
SoundB9:	binclude	"sound/SFX/soundB9.bin"
		even
SoundBA:	binclude	"sound/SFX/soundBA.bin"
		even
SoundBB:	binclude	"sound/SFX/soundBB.bin"
		even
SoundBC:	binclude	"sound/SFX/soundBC.bin"
		even
SoundBD:	binclude	"sound/SFX/soundBD.bin"
		even
SoundBE:	binclude	"sound/SFX/soundBE.bin"
		even
SoundBF:	binclude	"sound/SFX/soundBF.bin"
		even
SoundC0:	binclude	"sound/SFX/soundC0.bin"
		even
SoundC1:	binclude	"sound/SFX/soundC1.bin"
		even
SoundC2:	binclude	"sound/SFX/soundC2.bin"
		even
SoundC3:	binclude	"sound/SFX/soundC3.bin"
		even
SoundC4:	binclude	"sound/SFX/soundC4.bin"
		even
SoundC5:	binclude	"sound/SFX/soundC5.bin"
		even
SoundC6:	binclude	"sound/SFX/soundC6.bin"
		even
SoundC7:	binclude	"sound/SFX/soundC7.bin"
		even
SoundC8:	binclude	"sound/SFX/soundC8.bin"
		even
SoundC9:	binclude	"sound/SFX/soundC9.bin"
		even
SoundCA:	binclude	"sound/SFX/soundCA.bin"
		even
SoundCB:	binclude	"sound/SFX/soundCB.bin"
		even
SoundCC:	binclude	"sound/SFX/soundCC.bin"
		even
SoundCD:	binclude	"sound/SFX/soundCD.bin"
		even
SoundCE:	binclude	"sound/SFX/soundCE.bin"
		even
SoundCF:	binclude	"sound/SFX/soundCF.bin"
		even
SoundD0:	binclude	"sound/SFX/soundD0.bin"
		even
