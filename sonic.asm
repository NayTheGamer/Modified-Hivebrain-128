...
; ===========================================================================
	...
	include "Macros.asm"
	include "Ram-Additions.asm"		
	include	"_includes-ASM/Debugger.asm"	
...
Art_Text:	binclude	"_binary-files/artunc/menutext.bin"	; text used in level select and debug mode
		even
...
; ===========================================================================
Pal_TitleCyc:	binclude	"_binary-files/palletes/c_title.bin"
Pal_GHZCyc:	binclude	"_binary-files/palletes/c_ghz.bin"
Pal_LZCyc1:	binclude	"_binary-files/palletes/c_lz_wat.bin"	; waterfalls pallet
Pal_LZCyc2:	binclude	"_binary-files/palletes/c_lz_bel.bin"	; conveyor belt pallet
Pal_LZCyc3:	binclude	"_binary-files/palletes/c_lz_buw.bin"	; conveyor belt (underwater) pallet
Pal_SBZ3Cyc1:	binclude	"_binary-files/palletes/c_sbz3_w.bin"	; waterfalls pallet
Pal_SLZCyc:	binclude	"_binary-files/palletes/c_slz.bin"
Pal_SYZCyc1:	binclude	"_binary-files/palletes/c_syz_1.bin"
Pal_SYZCyc2:	binclude	"_binary-files/palletes/c_syz_2.bin"

Pal_SBZCycList:
	include "_includes-ASM/SBZ pallet script 1.asm"

Pal_SBZCycList2:
	include "_includes-ASM/SBZ pallet script 2.asm"

Pal_SBZCyc1:	binclude	"_binary-files/palletes/c_sbz_1.bin"
Pal_SBZCyc2:	binclude	"_binary-files/palletes/c_sbz_2.bin"
Pal_SBZCyc3:	binclude	"_binary-files/palletes/c_sbz_3.bin"
Pal_SBZCyc4:	binclude	"_binary-files/palletes/c_sbz_4.bin"
Pal_SBZCyc5:	binclude	"_binary-files/palletes/c_sbz_5.bin"
Pal_SBZCyc6:	binclude	"_binary-files/palletes/c_sbz_6.bin"
Pal_SBZCyc7:	binclude	"_binary-files/palletes/c_sbz_7.bin"
Pal_SBZCyc8:	binclude	"_binary-files/palletes/c_sbz_8.bin"
Pal_SBZCyc9:	binclude	"_binary-files/palletes/c_sbz_9.bin"
Pal_SBZCyc10:	binclude	"_binary-files/palletes/c_sbz_10.bin"
; ---------------------------------------------------------------------------
...
Pal_Sega1:	binclude	"_binary-files/palletes/sega1.bin"
Pal_Sega2:	binclude	"_binary-files/palletes/sega2.bin"
...
; ---------------------------------------------------------------------------
PalPointers:
	include "_includes-ASM/Pallet pointers.asm"

; ---------------------------------------------------------------------------
; Pallet data
; ---------------------------------------------------------------------------
Pal_SegaBG:	binclude	"_binary-files/palletes/sega_bg.bin"
Pal_Title:	binclude	"_binary-files/palletes/title.bin"
Pal_LevelSel:	binclude	"_binary-files/palletes/levelsel.bin"
Pal_Sonic:	binclude	"_binary-files/palletes/sonic.bin"
Pal_GHZ:	binclude	"_binary-files/palletes/ghz.bin"
Pal_LZ:		binclude	"_binary-files/palletes/lz.bin"
Pal_LZWater:	binclude	"_binary-files/palletes/lz_uw.bin"	; LZ underwater pallets
Pal_MZ:		binclude	"_binary-files/palletes/mz.bin"
Pal_SLZ:	binclude	"_binary-files/palletes/slz.bin"
Pal_SYZ:	binclude	"_binary-files/palletes/syz.bin"
Pal_SBZ1:	binclude	"_binary-files/palletes/sbz_act1.bin"	; SBZ act 1 pallets
Pal_SBZ2:	binclude	"_binary-files/palletes/sbz_act2.bin"	; SBZ act 2 & Final Zone pallets
Pal_Special:	binclude	"_binary-files/palletes/special.bin"	; special stage pallets
Pal_SBZ3:	binclude	"_binary-files/palletes/sbz_act3.bin"	; SBZ act 3 pallets
Pal_SBZ3Water:	binclude	"_binary-files/palletes/sbz_a3uw.bin"	; SBZ act 3 (underwater) pallets
Pal_LZSonWater:	binclude	"_binary-files/palletes/son_lzuw.bin"	; Sonic (underwater in LZ) pallet
Pal_SBZ3SonWat:	binclude	"_binary-files/palletes/son_sbzu.bin"	; Sonic (underwater in SBZ act 3) pallet
Pal_SpeResult:	binclude	"_binary-files/palletes/ssresult.bin"	; special stage results screen pallets
Pal_SpeContinue:binclude	"_binary-files/palletes/sscontin.bin"	; special stage results screen continue pallet
Pal_Ending:	binclude	"_binary-files/palletes/ending.bin"	; ending sequence pallets
...
Sine_Data:	binclude	"_misc/sinewave.bin"	; values for a 360º sine wave
...
Angle_Data:	binclude	"_misc/angles.bin"
...
; ---------------------------------------------------------------------------
LSelectPointers:
		binclude	"_misc/ls_point.bin"
		even
; ---------------------------------------------------------------------------
; Level	select codes
; ---------------------------------------------------------------------------
LevelSelectCode_J:
		binclude	"_misc/ls_jcode.bin"
		even

LevelSelectCode_US:
		binclude	"_misc/ls_ucode.bin"
		even
; ===========================================================================
...
; ---------------------------------------------------------------------------
Demo_Levels:	binclude	"_misc/dm_ord1.bin"
		even
...
; ---------------------------------------------------------------------------
LevelMenuText:	binclude	"_misc/menutext.bin"
		even
; ---------------------------------------------------------------------------
; Music	playlist
; ---------------------------------------------------------------------------
MusicList:	binclude	"_misc/muslist1.bin"
		even
; ===========================================================================
...
; ---------------------------------------------------------------------------
WaterHeight:	binclude	"_misc/lz_heigh.bin"
		even
; ===========================================================================
...
; ---------------------------------------------------------------------------
Demo_Index:
	include "_includes-ASM/Demo pointers for intro.asm"

Demo_EndIndex:
	include "_includes-ASM/Demo pointers for ending.asm"
...
; ---------------------------------------------------------------------------
ColPointers:
	include "_includes-ASM/Collision index pointers.asm"
...
; ===========================================================================
Demo_GHZ:	binclude	"_demodata/i_ghz.bin"
Demo_MZ:	binclude	"_demodata/i_mz.bin"
Demo_SYZ:	binclude	"_demodata/i_syz.bin"
Demo_SS:	binclude	"_demodata/i_ss.bin"
; ===========================================================================
...
Pal_SSCyc1:	binclude	"_binary-files/palletes/c_ss_1.bin"
		even
Pal_SSCyc2:	binclude	"_binary-files/palletes/c_ss_2.bin"
		even
...
; ===========================================================================
Ani_obj81:
	include "_animations/obj81.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Continue screen
; ---------------------------------------------------------------------------
Map_obj80:
	include "_mappings/obj80.asm"
...
; ---------------------------------------------------------------------------
EndDemo_Levels:	binclude	"_misc/dm_ord2.bin"
...
; ---------------------------------------------------------------------------
Map_obj8B:
	include "_mappings/obj8B.asm"

; ---------------------------------------------------------------------------
; Ending sequence demos
; ---------------------------------------------------------------------------
Demo_EndGHZ1:	binclude	"_demodata/e_ghz1.bin"
		even
Demo_EndMZ:	binclude	"_demodata/e_mz.bin"
		even
Demo_EndSYZ:	binclude	"_demodata/e_syz.bin"
		even
Demo_EndLZ:	binclude	"_demodata/e_lz.bin"
		even
Demo_EndSLZ:	binclude	"_demodata/e_slz.bin"
		even
Demo_EndSBZ1:	binclude	"_demodata/e_sbz1.bin"
		even
Demo_EndSBZ2:	binclude	"_demodata/e_sbz2.bin"
		even
Demo_EndGHZ2:	binclude	"_demodata/e_ghz2.bin"
		even
...
; ---------------------------------------------------------------------------
LevelSizeArray:	binclude	"_misc/lvl_size.bin"
		even

EndingStLocArray:
		binclude	"_misc/sloc_end.bin"
		even
...
StartLocArray:	binclude	"_level-data/start-position/ghz1.bin"
		binclude	"_level-data/start-position/ghz2.bin"
		binclude	"_level-data/start-position/ghz3.bin"
		binclude	"_level-data/start-position/ghz4.bin"
		...
		binclude	"_level-data/start-position/lz4.bin"
		...
		binclude	"_level-data/start-position/mz4.bin"
		...
		binclude	"_level-data/start-position/slz4.bin"
		...
		binclude	"_level-data/start-position/syz4.bin"
		...
		binclude	"_level-data/start-position/sbz4.bin"
		binclude	"_level-data/start-position/end1.bin"
		binclude	"_level-data/start-position/end2.bin"
		binclude	"_level-data/start-position/end3.bin"
		binclude	"_level-data/start-position/end4.bin"
		even
...
; ---------------------------------------------------------------------------
LoopTileNums:	binclude	"_misc/loopnums.bin"
		even
...
; ---------------------------------------------------------------------------
Obj11_BendData:	binclude	"_misc/ghzbend1.bin"
		even
Obj11_BendData2:binclude	"_misc/ghzbend2.bin"
		even
...
; ---------------------------------------------------------------------------
Map_obj15:
	include "_mappings/obj15ghz.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - SLZ	swinging platforms
; ---------------------------------------------------------------------------
Map_obj15a:
	include "_mappings/obj15slz.asm"
...
; ---------------------------------------------------------------------------
Map_obj18x:
	include "_mappings/obj18x.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - GHZ	platforms
; ---------------------------------------------------------------------------
Map_obj18:
	include "_mappings/obj18ghz.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - SYZ	platforms
; ---------------------------------------------------------------------------
Map_obj18a:
	include "_mappings/obj18syz.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - SLZ	platforms
; ---------------------------------------------------------------------------
Map_obj18b:
	include "_mappings/obj18slz.asm"
...
; ---------------------------------------------------------------------------
Map_obj1A:
	include "_mappings/obj1A.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - collapsing floors (MZ, SLZ,	SBZ)
; ---------------------------------------------------------------------------
Map_obj53:
	include "_mappings/obj53.asm"
...
; ===========================================================================
Ani_obj2A:
	include "_animations/obj2A.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - doors (SBZ)
; ---------------------------------------------------------------------------
Map_obj2A:
	include "_mappings/obj2A.asm"
...
; ===========================================================================
Ani_obj1E:
	include "_animations/obj1E.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Ball Hog enemy (SBZ)
; ---------------------------------------------------------------------------
Map_obj1E:
	include "_mappings/obj1E.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - explosion
; ---------------------------------------------------------------------------
Map_obj24:
	include "_mappings/obj24.asm"
...
; ---------------------------------------------------------------------------
Map_obj28:
	include "_mappings/obj28.asm"

Map_obj28a:
	include "_mappings/obj28a.asm"

Map_obj28b:
	include "_mappings/obj28b.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - points that	appear when you	destroy	something
; ---------------------------------------------------------------------------
Map_obj29:
	include "_mappings/obj29.asm"
...
; ===========================================================================
Ani_obj1F:
	include "_animations/obj1F.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Crabmeat enemy (GHZ, SYZ)
; ---------------------------------------------------------------------------
Map_obj1F:
	include "_mappings/obj1F.asm"
...
; ===========================================================================
Ani_obj22:
	include "_animations/obj22.asm"

Ani_obj23:
	include "_animations/obj23.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Buzz Bomber	enemy
; ---------------------------------------------------------------------------
Map_obj22:
	include "_mappings/obj22.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - missile that Buzz Bomber throws
; ---------------------------------------------------------------------------
Map_obj23:
	include "_mappings/obj23.asm"
...
; ===========================================================================
Ani_obj25:
	include "_animations/obj25.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - rings
; ---------------------------------------------------------------------------
Map_obj25:
	include "_mappings/obj25.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - giant ring
; ---------------------------------------------------------------------------
Map_obj4B:
	include "_mappings/obj4B.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - flash effect when you collect the giant ring
; ---------------------------------------------------------------------------
Map_obj7C:
	include "_mappings/obj7C.asm"
...
; ===========================================================================
Ani_obj26:
	include "_animations/obj26.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - monitors
; ---------------------------------------------------------------------------
Map_obj26:
	include "_mappings/obj26.asm"
...
; ===========================================================================
Ani_obj0E:
	include "_animations/obj0E.asm"

Ani_obj0F:
	include "_animations/obj0F.asm"
...
; ---------------------------------------------------------------------------
Map_obj0F:
	include "_mappings/obj0F.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Sonic on the title screen
; ---------------------------------------------------------------------------
Map_obj0E:
	include "_mappings/obj0E.asm"
...
; ===========================================================================
Ani_obj2B:
	include "_animations/obj2B.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Chopper enemy (GHZ)
; ---------------------------------------------------------------------------
Map_obj2B:
	include "_mappings/obj2B.asm"
...
; ===========================================================================
Ani_obj2C:
	include "_animations/obj2C.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Jaws enemy (LZ)
; ---------------------------------------------------------------------------
Map_obj2C:
	include "_mappings/obj2C.asm"
...
; ===========================================================================
Ani_obj2D:
	include "_animations/obj2D.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Burrobot enemy (LZ)
; ---------------------------------------------------------------------------
Map_obj2D:
	include "_mappings/obj2D.asm"
...
; ---------------------------------------------------------------------------
Obj2F_Data1:	binclude	"_misc/mz_pfm1.bin"
		even
Obj2F_Data2:	binclude	"_misc/mz_pfm2.bin"
		even
Obj2F_Data3:	binclude	"_misc/mz_pfm3.bin"
		even
; ===========================================================================
; ---------------------------------------------------------------------------
...
; ===========================================================================
Ani_obj35:
	include "_animations/obj35.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - large moving platforms (MZ)
; ---------------------------------------------------------------------------
Map_obj2F:
	include "_mappings/obj2F.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - lava balls (MZ, SLZ)
; ---------------------------------------------------------------------------
Map_obj14:
	include "_mappings/obj14.asm"
...
; Level	order array
; ---------------------------------------------------------------------------
LevelOrder:	binclude	"_misc/lvl_ord.bin"
		even
; ===========================================================================
...
; ---------------------------------------------------------------------------
Obj_Index:
	include "_includes-ASM/Object pointers.asm"
...
; ===========================================================================
Ani_obj41:
	include "_animations/obj41.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - springs
; ---------------------------------------------------------------------------
Map_obj41:
	include "_mappings/obj41.asm"
...
; ===========================================================================
Ani_obj42:
	include "_animations/obj42.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Newtron enemy (GHZ)
; ---------------------------------------------------------------------------
Map_obj42:
	include "_mappings/obj42.asm"
...
; ===========================================================================
Ani_obj43:
	include "_animations/obj43.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Roller enemy (SYZ)
; ---------------------------------------------------------------------------
Map_obj43:
	include "_mappings/obj43.asm"
...
; ===========================================================================
Ani_obj6D:
	include "_animations/obj6D.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - flame thrower (SBZ)
; ---------------------------------------------------------------------------
Map_obj6D:
	include "_mappings/obj6D.asm"
...
; ===========================================================================
Ani_obj47:
	include "_animations/obj47.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - pinball bumper (SYZ)
; ---------------------------------------------------------------------------
Map_obj47:
	include "_mappings/obj47.asm"
...
; ===========================================================================
Ani_obj0D:
	include "_animations/obj0D.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - signpost
; ---------------------------------------------------------------------------
Map_obj0D:
	include "_mappings/obj0D.asm"
...
; ---------------------------------------------------------------------------
Map_obj54:
	include "_mappings/obj54.asm"

Ani_obj4C:
	include "_animations/obj4C.asm"

Ani_obj4E:
	include "_animations/obj4E.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - lava geyser / lava that falls from the ceiling (MZ)
; ---------------------------------------------------------------------------
Map_obj4C:
	include "_mappings/obj4C.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - advancing wall of lava (MZ)
; ---------------------------------------------------------------------------
Map_obj4E:
	include "_mappings/obj4E.asm"
...
; ===========================================================================
Ani_obj40:
	include "_animations/obj40.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Moto Bug enemy (GHZ)
; ---------------------------------------------------------------------------
Map_obj40:
	include "_mappings/obj40.asm"
...
; ===========================================================================
Ani_obj50:
	include "_animations/obj50.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Yadrin enemy (SYZ)
; ---------------------------------------------------------------------------
Map_obj50:
	include "_mappings/obj50.asm"
...
; ---------------------------------------------------------------------------
Map_obj52:
	include "_mappings/obj52mz.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - moving block (LZ)
; ---------------------------------------------------------------------------
Map_obj52a:
	include "_mappings/obj52lz.asm"
...
; ===========================================================================
Ani_obj55:
	include "_animations/obj55.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Basaran enemy (MZ)
; ---------------------------------------------------------------------------
Map_obj55:
	include "_mappings/obj55.asm"
...
; ---------------------------------------------------------------------------
Map_obj57:
	include "_mappings/obj57syz.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - spiked ball	on a chain (LZ)
; ---------------------------------------------------------------------------
Map_obj57a:
	include "_mappings/obj57lz.asm"
...
; ---------------------------------------------------------------------------
Map_obj15b:
	include "_mappings/obj15sbz.asm"
...
; ===========================================================================
Ani_obj0C:
	include "_animations/obj0C.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - flapping door (LZ)
; ---------------------------------------------------------------------------
Map_obj0C:
	include "_mappings/obj0C.asm"
...
Obj5E_Data1:	binclude	"_misc/slzssaw1.bin"
		even
Obj5E_Data2:	binclude	"_misc/slzssaw2.bin"
		even
; ---------------------------------------------------------------------------
; Sprite mappings - seesaws (SLZ)
; ---------------------------------------------------------------------------
Map_obj5E:
	include "_mappings/obj5E.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - spiked balls on the	seesaws	(SLZ)
; ---------------------------------------------------------------------------
Map_obj5Ea:
	include "_mappings/obj5Eballs.asm"
...
Ani_obj5F:
	include "_animations/obj5F.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - walking bomb enemy (SLZ, SBZ)
; ---------------------------------------------------------------------------
Map_obj5F:
	include "_mappings/obj5F.asm"
...
; ===========================================================================
Ani_obj60:
	include "_animations/obj60.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Orbinaut enemy (LZ,	SLZ, SBZ)
; ---------------------------------------------------------------------------
Map_obj60:
	include "_mappings/obj60.asm"
...
; ===========================================================================
Ani_obj16:
	include "_animations/obj16.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - harpoon (LZ)
; ---------------------------------------------------------------------------
Map_obj16:
	include "_mappings/obj16.asm"
...
; ===========================================================================
Ani_obj64:
	include "_animations/obj64.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - bubbles (LZ)
; ---------------------------------------------------------------------------
Map_obj64:
	include "_mappings/obj64.asm"
...
; ===========================================================================
Ani_obj65:
	include "_animations/obj65.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - waterfalls (LZ)
; ---------------------------------------------------------------------------
Map_obj65:
	include "_mappings/obj65.asm"
...
; ---------------------------------------------------------------------------
MusicList2:	binclude	"_misc/muslist2.bin"
		even
; ===========================================================================
...
; ===========================================================================
Ani_obj0A:
	include "_animations/obj0A.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - drowning countdown numbers (LZ)
; ---------------------------------------------------------------------------
Map_obj0A:
	include "_mappings/obj0A.asm"
...
; ===========================================================================
Ani_obj38:
	include "_animations/obj38.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - shield and invincibility stars
; ---------------------------------------------------------------------------
Map_obj38:
	include "_mappings/obj38.asm"

Ani_obj4A:
	include "_animations/obj4A.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - special stage entry	from beta
; ---------------------------------------------------------------------------
Map_obj4A:
	include "_mappings/obj4A.asm"

Ani_obj08:
	include "_animations/obj08.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - water splash (LZ)
; ---------------------------------------------------------------------------
Map_obj08:
	include "_mappings/obj08.asm"
...
; ===========================================================================
Ani_obj69:
	include "_animations/obj69.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - trapdoor (SBZ)
; ---------------------------------------------------------------------------
Map_obj69:
	include "_mappings/obj69.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - spinning platforms (SBZ)
; ---------------------------------------------------------------------------
Map_obj69a:
	include "_mappings/obj69a.asm"
...
; ===========================================================================
Ani_obj6C:
	include "_animations/obj6C.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - vanishing platforms	(SBZ)
; ---------------------------------------------------------------------------
Map_obj6C:
	include "_mappings/obj6C.asm"
...
; ===========================================================================
Ani_obj6E:
	include "_animations/obj6E.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - electrocution orbs (SBZ)
; ---------------------------------------------------------------------------
Map_obj6E:
	include "_mappings/obj6E.asm"
...
; ===========================================================================
Ani_obj78:
	include "_animations/obj78.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Caterkiller	enemy (MZ, SBZ)
; ---------------------------------------------------------------------------
Map_obj78:
	include "_mappings/obj78.asm"
...
; ===========================================================================
Ani_obj82:
	include "_animations/obj82.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - Eggman (SBZ2)
; ---------------------------------------------------------------------------
Map_obj82:
	include "_mappings/obj82.asm"
...
; ===========================================================================
Ani_obj85:
	include "_animations/obj85.asm"

Map_Eggman2:
	include "_mappings/Eggman2.asm"

Map_FZBoss:
	include "_mappings/FZ boss.asm"
...
; ===========================================================================
Ani_obj86:
	include "_animations/obj86.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - energy ball	launcher (FZ)
; ---------------------------------------------------------------------------
Map_obj86:
	include "_mappings/obj86.asm"

Ani_obj86a:
	include "_animations/obj86a.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - energy balls (FZ)
; ---------------------------------------------------------------------------
Map_obj86a:
	include "_mappings/obj86a.asm"
...
; ===========================================================================
Ani_obj3E:
	include "_animations/obj3E.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - prison capsule
; ---------------------------------------------------------------------------
Map_obj3E:
	include "_mappings/obj3E.asm"
...
; ---------------------------------------------------------------------------
SS_LayoutIndex:
	include "_includes-ASM/Special stage layout pointers.asm"

; ---------------------------------------------------------------------------
; Special stage	start locations
; ---------------------------------------------------------------------------
SS_StartLoc:	binclude	"_misc/sloc_ss.bin"
		even
...
; ---------------------------------------------------------------------------
SS_MapIndex:
	include "_includes-ASM/Special stage mappings and VRAM pointers.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - special stage "R" block
; ---------------------------------------------------------------------------
Map_SS_R:
	include "_mappings/SSRblock.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - special stage breakable glass blocks and red-white blocks
; ---------------------------------------------------------------------------
Map_SS_Glass:
	include "_mappings/SSglassblock.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - special stage "UP" block
; ---------------------------------------------------------------------------
Map_SS_Up:
	include "_mappings/SSUPblock.asm"

; ---------------------------------------------------------------------------
; Sprite mappings - special stage "DOWN" block
; ---------------------------------------------------------------------------
Map_SS_Down:
	include "_mappings/SSDOWNblock.asm"
...
; ===========================================================================
Art_Hud:	binclude	"_binary-files/artunc/HUD.bin"		; 8x16 pixel numbers on HUD
		even
Art_LivesNums:	binclude	"_binary-files/artunc/livescnt.bin"	; 8x8 pixel numbers on lives counter
		even
; ===========================================================================
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
DebugList:
	include "_includes-ASM/Debug list pointers.asm"

; ---------------------------------------------------------------------------
; Debug	list - Green Hill
; ---------------------------------------------------------------------------
Debug_GHZ:
	include "_includes-ASM/Debug list - GHZ.asm"

; ---------------------------------------------------------------------------
; Debug	list - Labyrinth
; ---------------------------------------------------------------------------
Debug_LZ:
	include "_includes-ASM/Debug list - LZ.asm"

; ---------------------------------------------------------------------------
; Debug	list - Marble
; ---------------------------------------------------------------------------
Debug_MZ:
	include "_includes-ASM/Debug list - MZ.asm"

; ---------------------------------------------------------------------------
; Debug	list - Star Light
; ---------------------------------------------------------------------------
Debug_SLZ:
	include "_includes-ASM/Debug list - SLZ.asm"

; ---------------------------------------------------------------------------
; Debug	list - Spring Yard
; ---------------------------------------------------------------------------
Debug_SYZ:
	include "_includes-ASM/Debug list - SYZ.asm"

; ---------------------------------------------------------------------------
; Debug	list - Scrap Brain
; ---------------------------------------------------------------------------
Debug_SBZ:
	include "_includes-ASM/Debug list - SBZ.asm"

; ---------------------------------------------------------------------------
; Debug	list - ending sequence / special stage
; ---------------------------------------------------------------------------
Debug_Ending:
	include "_includes-ASM/Debug list - Ending and SS.asm"

; ---------------------------------------------------------------------------
; Main level load blocks
; ---------------------------------------------------------------------------
MainLoadBlocks:
	include "_includes-ASM/Main level load blocks.asm"

; ---------------------------------------------------------------------------
; Pattern load cues
; ---------------------------------------------------------------------------
ArtLoadCues:
	include "_includes-ASM/Pattern load cues.asm"

Nem_SegaLogo:	binclude	"_binary-files/artnem/segalogo.bin"	; large Sega logo
		even
Eni_SegaLogo:	binclude	"_tilemaps/segalogo.bin"	; large Sega logo (mappings)
		even
Eni_Title:	binclude	"_tilemaps/titlescr.bin"	; title screen foreground (mappings)
		even
Nem_TitleFg:	binclude	"_binary-files/artnem/titlefor.bin"	; title screen foreground
		even
Nem_TitleSonic:	binclude	"_binary-files/artnem/titleson.bin"	; Sonic on title screen
		even
Nem_TitleTM:	binclude	"_binary-files/artnem/titletm.bin"	; TM on title screen
		even
Eni_JapNames:	binclude	"_tilemaps/japcreds.bin"	; Japanese credits (mappings)
		even
Nem_JapNames:	binclude	"_binary-files/artnem/japcreds.bin"	; Japanese credits
		even
; ---------------------------------------------------------------------------
; Sprite mappings - Sonic
; ---------------------------------------------------------------------------
Map_Sonic:
	include "_mappings/Sonic.asm"

; ---------------------------------------------------------------------------
; Uncompressed graphics	loading	array for Sonic
; ---------------------------------------------------------------------------
SonicDynPLC:
	include "_includes-ASM/Sonic dynamic pattern load cues.asm"

; ---------------------------------------------------------------------------
; Uncompressed graphics	- Sonic
; ---------------------------------------------------------------------------
Art_Sonic:	binclude	"_binary-files/artunc/sonic.bin"	; Sonic
		even
; ---------------------------------------------------------------------------
; Compressed graphics - various
; ---------------------------------------------------------------------------
Nem_Smoke:	binclude	"_binary-files/artnem/xxxsmoke.bin"	; unused smoke
		even
Nem_SyzSparkle:	binclude	"_binary-files/artnem/xxxstars.bin"	; unused stars
		even
Nem_Shield:	binclude	"_binary-files/artnem/shield.bin"	; shield
		even
Nem_Stars:	binclude	"_binary-files/artnem/invstars.bin"	; invincibility stars
		even
Nem_LzSonic:	binclude	"_binary-files/artnem/xxxlzson.bin"	; unused LZ Sonic holding his breath
		even
Nem_UnkFire:	binclude	"_binary-files/artnem/xxxfire.bin"	; unused fireball
		even
Nem_Warp:	binclude	"_binary-files/artnem/xxxflash.bin"	; unused entry to special stage flash
		even
Nem_Goggle:	binclude	"_binary-files/artnem/xxxgoggl.bin"	; unused goggles
		even
; ---------------------------------------------------------------------------
; Sprite mappings - walls of the special stage
; ---------------------------------------------------------------------------
Map_SSWalls:
	include "_mappings/SSwalls.asm"
; ---------------------------------------------------------------------------
; Compressed graphics - special stage
; ---------------------------------------------------------------------------
Nem_SSWalls:	binclude	"_binary-files/artnem/sswalls.bin"	; special stage walls
		even
Eni_SSBg1:	binclude	"_tilemaps/ssbg1.bin"	; special stage background (mappings)
		even
Nem_SSBgFish:	binclude	"_binary-files/artnem/ssbg1.bin"	; special stage birds and fish background
		even
Eni_SSBg2:	binclude	"_tilemaps/ssbg2.bin"	; special stage background (mappings)
		even
Nem_SSBgCloud:	binclude	"_binary-files/artnem/ssbg2.bin"	; special stage clouds background
		even
Nem_SSGOAL:	binclude	"_binary-files/artnem/ssgoal.bin"	; special stage GOAL block
		even
Nem_SSRBlock:	binclude	"_binary-files/artnem/ssr.bin"		; special stage R block
		even
Nem_SS1UpBlock:	binclude	"_binary-files/artnem/ss1up.bin"	; special stage 1UP block
		even
Nem_SSEmStars:	binclude	"_binary-files/artnem/ssemstar.bin"	; special stage stars from a collected emerald
		even
Nem_SSRedWhite:	binclude	"_binary-files/artnem/ssredwhi.bin"	; special stage red/white block
		even
Nem_SSZone1:	binclude	"_binary-files/artnem/sszone1.bin"	; special stage ZONE1 block
		even
Nem_SSZone2:	binclude	"_binary-files/artnem/sszone2.bin"	; ZONE2 block
		even
Nem_SSZone3:	binclude	"_binary-files/artnem/sszone3.bin"	; ZONE3 block
		even
Nem_SSZone4:	binclude	"_binary-files/artnem/sszone4.bin"	; ZONE4 block
		even
Nem_SSZone5:	binclude	"_binary-files/artnem/sszone5.bin"	; ZONE5 block
		even
Nem_SSZone6:	binclude	"_binary-files/artnem/sszone6.bin"	; ZONE6 block
		even
Nem_SSUpDown:	binclude	"_binary-files/artnem/ssupdown.bin"	; special stage UP/DOWN block
		even
Nem_SSEmerald:	binclude	"_binary-files/artnem/ssemeral.bin"	; special stage chaos emeralds
		even
Nem_SSGhost:	binclude	"_binary-files/artnem/ssghost.bin"	; special stage ghost block
		even
Nem_SSWBlock:	binclude	"_binary-files/artnem/ssw.bin"		; special stage W block
		even
Nem_SSGlass:	binclude	"_binary-files/artnem/ssglass.bin"	; special stage destroyable glass block
		even
Nem_ResultEm:	binclude	"_binary-files/artnem/ssresems.bin"	; chaos emeralds on special stage results screen
		even
; ---------------------------------------------------------------------------
; Compressed graphics - GHZ stuff
; ---------------------------------------------------------------------------
Nem_Stalk:	binclude	"_binary-files/artnem/ghzstalk.bin"	; GHZ flower stalk
		even
Nem_Swing:	binclude	"_binary-files/artnem/ghzswing.bin"	; GHZ swinging platform
		even
Nem_Bridge:	binclude	"_binary-files/artnem/ghzbridg.bin"	; GHZ bridge
		even
Nem_GhzUnkBlock:binclude	"_binary-files/artnem/xxxghzbl.bin"	; unused GHZ block
		even
Nem_Ball:	binclude	"_binary-files/artnem/ghzball.bin"	; GHZ giant ball
		even
Nem_Spikes:	binclude	"_binary-files/artnem/spikes.bin"	; spikes
		even
Nem_GhzLog:	binclude	"_binary-files/artnem/xxxghzlo.bin"	; unused GHZ log
		even
Nem_SpikePole:	binclude	"_binary-files/artnem/ghzlog.bin"	; GHZ spiked log
		even
Nem_PplRock:	binclude	"_binary-files/artnem/ghzrock.bin"	; GHZ purple rock
		even
Nem_GhzWall1:	binclude	"_binary-files/artnem/ghzwall1.bin"	; GHZ destroyable wall
		even
Nem_GhzWall2:	binclude	"_binary-files/artnem/ghzwall2.bin"	; GHZ normal wall
		even
; ---------------------------------------------------------------------------
; Compressed graphics - LZ stuff
; ---------------------------------------------------------------------------
Nem_Water:	binclude	"_binary-files/artnem/lzwater.bin"	; LZ water surface
		even
Nem_Splash:	binclude	"_binary-files/artnem/lzsplash.bin"	; LZ waterfalls and splashes
		even
Nem_LzSpikeBall:binclude	"_binary-files/artnem/lzspball.bin"	; LZ spiked ball on chain
		even
Nem_FlapDoor:	binclude	"_binary-files/artnem/lzflapdo.bin"	; LZ flapping door
		even
Nem_Bubbles:	binclude	"_binary-files/artnem/lzbubble.bin"	; LZ bubbles and countdown numbers
		even
Nem_LzBlock3:	binclude	"_binary-files/artnem/lzblock3.bin"	; LZ 32x16 block
		even
Nem_LzDoor1:	binclude	"_binary-files/artnem/lzvdoor.bin"	; LZ vertical door
		even
Nem_Harpoon:	binclude	"_binary-files/artnem/lzharpoo.bin"	; LZ harpoon
		even
Nem_LzPole:	binclude	"_binary-files/artnem/lzpole.bin"	; LZ pole that breaks
		even
Nem_LzDoor2:	binclude	"_binary-files/artnem/lzhdoor.bin"	; LZ large horizontal door
		even
Nem_LzWheel:	binclude	"_binary-files/artnem/lzwheel.bin"	; LZ wheel from corner of conveyor belt
		even
Nem_Gargoyle:	binclude	"_binary-files/artnem/lzgargoy.bin"	; LZ gargoyle head and spitting fire
		even
Nem_LzBlock2:	binclude	"_binary-files/artnem/lzblock2.bin"	; LZ blocks
		even
Nem_LzPlatfm:	binclude	"_binary-files/artnem/lzptform.bin"	; LZ rising platforms
		even
Nem_Cork:	binclude	"_binary-files/artnem/lzcork.bin"	; LZ cork block
		even
Nem_LzBlock1:	binclude	"_binary-files/artnem/lzblock1.bin"	; LZ 32x32 block
		even
; ---------------------------------------------------------------------------
; Compressed graphics - MZ stuff
; ---------------------------------------------------------------------------
Nem_MzMetal:	binclude	"_binary-files/artnem/mzmetal.bin"	; MZ metal blocks
		even
Nem_MzSwitch:	binclude	"_binary-files/artnem/mzswitch.bin"	; MZ switch
		even
Nem_MzGlass:	binclude	"_binary-files/artnem/mzglassy.bin"	; MZ green glassy block
		even
Nem_GhzGrass:	binclude	"_binary-files/artnem/xxxgrass.bin"	; unused grass (GHZ or MZ?)
		even
Nem_MzFire:	binclude	"_binary-files/artnem/mzfire.bin"	; MZ fireballs
		even
Nem_Lava:	binclude	"_binary-files/artnem/mzlava.bin"	; MZ lava
		even
Nem_MzBlock:	binclude	"_binary-files/artnem/mzblock.bin"	; MZ green pushable block
		even
Nem_MzUnkBlock:	binclude	"_binary-files/artnem/xxxmzblo.bin"	; MZ unused background block
		even
; ---------------------------------------------------------------------------
; Compressed graphics - SLZ stuff
; ---------------------------------------------------------------------------
Nem_Seesaw:	binclude	"_binary-files/artnem/slzseesa.bin"	; SLZ seesaw
		even
Nem_SlzSpike:	binclude	"_binary-files/artnem/slzspike.bin"	; SLZ spikeball that sits on a seesaw
		even
Nem_Fan:	binclude	"_binary-files/artnem/slzfan.bin"	; SLZ fan
		even
Nem_SlzWall:	binclude	"_binary-files/artnem/slzwall.bin"	; SLZ smashable wall
		even
Nem_Pylon:	binclude	"_binary-files/artnem/slzpylon.bin"	; SLZ foreground pylon
		even
Nem_SlzSwing:	binclude	"_binary-files/artnem/slzswing.bin"	; SLZ swinging platform
		even
Nem_SlzBlock:	binclude	"_binary-files/artnem/slzblock.bin"	; SLZ 32x32 block
		even
Nem_SlzCannon:	binclude	"_binary-files/artnem/slzcanno.bin"	; SLZ fireball launcher cannon
		even
; ---------------------------------------------------------------------------
; Compressed graphics - SYZ stuff
; ---------------------------------------------------------------------------
Nem_Bumper:	binclude	"_binary-files/artnem/syzbumpe.bin"	; SYZ bumper
		even
Nem_SyzSpike2:	binclude	"_binary-files/artnem/syzsspik.bin"	; SYZ small spikeball
		even
Nem_LzSwitch:	binclude	"_binary-files/artnem/switch.bin"	; LZ/SYZ/SBZ switch
		even
Nem_SyzSpike1:	binclude	"_binary-files/artnem/syzlspik.bin"	; SYZ/SBZ large spikeball
		even
; ---------------------------------------------------------------------------
; Compressed graphics - SBZ stuff
; ---------------------------------------------------------------------------
Nem_SbzWheel1:	binclude	"_binary-files/artnem/sbzwhee1.bin"	; SBZ spot on rotating wheel that Sonic runs around
		even
Nem_SbzWheel2:	binclude	"_binary-files/artnem/sbzwhee2.bin"	; SBZ wheel that grabs Sonic
		even
Nem_Cutter:	binclude	"_binary-files/artnem/sbzcutte.bin"	; SBZ pizza cutter
		even
Nem_Stomper:	binclude	"_binary-files/artnem/sbzstomp.bin"	; SBZ stomper
		even
Nem_SpinPform:	binclude	"_binary-files/artnem/sbzpform.bin"	; SBZ spinning platform
		even
Nem_TrapDoor:	binclude	"_binary-files/artnem/sbztrapd.bin"	; SBZ trapdoor
		even
Nem_SbzFloor:	binclude	"_binary-files/artnem/sbzfloor.bin"	; SBZ collapsing floor
		even
Nem_Electric:	binclude	"_binary-files/artnem/sbzshock.bin"	; SBZ electric shock orb
		even
Nem_SbzBlock:	binclude	"_binary-files/artnem/sbzvanis.bin"	; SBZ vanishing block
		even
Nem_FlamePipe:	binclude	"_binary-files/artnem/sbzflame.bin"	; SBZ flaming pipe
		even
Nem_SbzDoor1:	binclude	"_binary-files/artnem/sbzvdoor.bin"	; SBZ small vertical door
		even
Nem_SlideFloor:	binclude	"_binary-files/artnem/sbzslide.bin"	; SBZ floor that slides away
		even
Nem_SbzDoor2:	binclude	"_binary-files/artnem/sbzhdoor.bin"	; SBZ large horizontal door
		even
Nem_Girder:	binclude	"_binary-files/artnem/sbzgirde.bin"	; SBZ crushing girder
		even
; ---------------------------------------------------------------------------
; Compressed graphics - enemies
; ---------------------------------------------------------------------------
Nem_BallHog:	binclude	"_binary-files/artnem/ballhog.bin"	; ball hog
		even
Nem_Crabmeat:	binclude	"_binary-files/artnem/crabmeat.bin"	; crabmeat
		even
Nem_Buzz:	binclude	"_binary-files/artnem/buzzbomb.bin"	; buzz bomber
		even
Nem_UnkExplode:	binclude	"_binary-files/artnem/xxxexplo.bin"	; unused explosion
		even
Nem_Burrobot:	binclude	"_binary-files/artnem/burrobot.bin"	; burrobot
		even
Nem_Chopper:	binclude	"_binary-files/artnem/chopper.bin"	; chopper
		even
Nem_Jaws:	binclude	"_binary-files/artnem/jaws.bin"		; jaws
		even
Nem_Roller:	binclude	"_binary-files/artnem/roller.bin"	; roller
		even
Nem_Motobug:	binclude	"_binary-files/artnem/motobug.bin"	; moto bug
		even
Nem_Newtron:	binclude	"_binary-files/artnem/newtron.bin"	; newtron
		even
Nem_Yadrin:	binclude	"_binary-files/artnem/yadrin.bin"	; yadrin
		even
Nem_Basaran:	binclude	"_binary-files/artnem/basaran.bin"	; basaran
		even
Nem_Splats:	binclude	"_binary-files/artnem/splats.bin"	; splats
		even
Nem_Bomb:	binclude	"_binary-files/artnem/bomb.bin"		; bomb
		even
Nem_Orbinaut:	binclude	"_binary-files/artnem/orbinaut.bin"	; orbinaut
		even
Nem_Cater:	binclude	"_binary-files/artnem/caterkil.bin"	; caterkiller
		even
; ---------------------------------------------------------------------------
; Compressed graphics - various
; ---------------------------------------------------------------------------
Nem_TitleCard:	binclude	"_binary-files/artnem/ttlcards.bin"	; title cards
		even
Nem_Hud:	binclude	"_binary-files/artnem/hud.bin"		; HUD (rings, time, score)
		even
Nem_Lives:	binclude	"_binary-files/artnem/lifeicon.bin"	; life counter icon
		even
Nem_Ring:	binclude	"_binary-files/artnem/rings.bin"	; rings
		even
Nem_Monitors:	binclude	"_binary-files/artnem/monitors.bin"	; monitors
		even
Nem_Explode:	binclude	"_binary-files/artnem/explosio.bin"	; explosion
		even
Nem_Points:	binclude	"_binary-files/artnem/points.bin"	; points from destroyed enemy or object
		even
Nem_GameOver:	binclude	"_binary-files/artnem/gameover.bin"	; game over / time over
		even
Nem_HSpring:	binclude	"_binary-files/artnem/springh.bin"	; horizontal spring
		even
Nem_VSpring:	binclude	"_binary-files/artnem/springv.bin"	; vertical spring
		even
Nem_SignPost:	binclude	"_binary-files/artnem/signpost.bin"	; end of level signpost
		even
Nem_Lamp:	binclude	"_binary-files/artnem/lamppost.bin"	; lamppost
		even
Nem_BigFlash:	binclude	"_binary-files/artnem/rngflash.bin"	; flash from giant ring
		even
Nem_Bonus:	binclude	"_binary-files/artnem/bonus.bin"	; hidden bonuses at end of a level
		even
; ---------------------------------------------------------------------------
; Compressed graphics - continue screen
; ---------------------------------------------------------------------------
Nem_ContSonic:	binclude	"_binary-files/artnem/cntsonic.bin"	; Sonic on continue screen
		even
Nem_MiniSonic:	binclude	"_binary-files/artnem/cntother.bin"	; mini Sonic and text on continue screen
		even
; ---------------------------------------------------------------------------
; Compressed graphics - animals
; ---------------------------------------------------------------------------
Nem_Rabbit:	binclude	"_binary-files/artnem/rabbit.bin"	; rabbit
		even
Nem_Chicken:	binclude	"_binary-files/artnem/chicken.bin"	; chicken
		even
Nem_BlackBird:	binclude	"_binary-files/artnem/blackbrd.bin"	; blackbird
		even
Nem_Seal:	binclude	"_binary-files/artnem/seal.bin"		; seal
		even
Nem_Pig:	binclude	"_binary-files/artnem/pig.bin"		; pig
		even
Nem_Flicky:	binclude	"_binary-files/artnem/flicky.bin"	; flicky
		even
Nem_Squirrel:	binclude	"_binary-files/artnem/squirrel.bin"	; squirrel
		even
; ---------------------------------------------------------------------------
; Compressed graphics - primary patterns and block mappings
; ---------------------------------------------------------------------------

Nem_TIT_1st:	binclude	"_binary-files/artnem/8x8tit1.bin"	; Title primary patterns
		even
Nem_TIT_2nd:	binclude	"_binary-files/artnem/8x8tit2.bin"	; Title secondary patterns
		even
Blk16_GHZ:	binclude	"_level-data/map-16x16-blocks/ghz.bin"
		even
Nem_GHZ:	binclude	"_binary-files/artnem/8x8ghz.bin"	; GHZ primary patterns
		even
Blk256_GHZ:	binclude	"_level-data/map-128x128-chunks/ghz.bin"
		even
Blk16_LZ:	binclude	"_level-data/map-16x16-blocks/lz.bin"
		even
Nem_LZ:		binclude	"_binary-files/artnem/8x8lz.bin"	; LZ primary patterns
		even
Blk256_LZ:	binclude	"_level-data/map-128x128-chunks/lz.bin"
		even
Blk16_MZ:	binclude	"_level-data/map-16x16-blocks/mz.bin"
		even
Nem_MZ:		binclude	"_binary-files/artnem/8x8mz.bin"	; MZ primary patterns
		even
Blk256_MZ:	binclude	"_level-data/map-128x128-chunks/mz.bin"
		even
Blk16_SLZ:	binclude	"_level-data/map-16x16-blocks/slz.bin"
		even
Nem_SLZ:	binclude	"_binary-files/artnem/8x8slz.bin"	; SLZ primary patterns
		even
Blk256_SLZ:	binclude	"_level-data/map-128x128-chunks/slz.bin"
		even
Blk16_SYZ:	binclude	"_level-data/map-16x16-blocks/syz.bin"
		even
Nem_SYZ:	binclude	"_binary-files/artnem/8x8syz.bin"	; SYZ primary patterns
		even
Blk256_SYZ:	binclude	"_level-data/map-128x128-chunks/syz.bin"
		even
Blk16_SBZ:	binclude	"_level-data/map-16x16-blocks/sbz.bin"
		even
Nem_SBZ:	binclude	"_binary-files/artnem/8x8sbz.bin"	; SBZ primary patterns
		even
Blk256_SBZ:	binclude	"_level-data/map-128x128-chunks/sbz.bin"
		even
; ---------------------------------------------------------------------------
; Compressed graphics - bosses and ending sequence
; ---------------------------------------------------------------------------
Nem_Eggman:	binclude	"_binary-files/artnem/bossmain.bin"	; boss main patterns
		even
Nem_Weapons:	binclude	"_binary-files/artnem/bossxtra.bin"	; boss add-ons and weapons
		even
Nem_Prison:	binclude	"_binary-files/artnem/prison.bin"	; prison capsule
		even
Nem_Sbz2Eggman:	binclude	"_binary-files/artnem/sbz2boss.bin"	; Eggman in SBZ2 and FZ
		even
Nem_FzBoss:	binclude	"_binary-files/artnem/fzboss.bin"	; FZ boss
		even
Nem_FzEggman:	binclude	"_binary-files/artnem/fzboss2.bin"	; Eggman after the FZ boss
		even
Nem_Exhaust:	binclude	"_binary-files/artnem/bossflam.bin"	; boss exhaust flame
		even
Nem_EndEm:	binclude	"_binary-files/artnem/endemera.bin"	; ending sequence chaos emeralds
		even
Nem_EndSonic:	binclude	"_binary-files/artnem/endsonic.bin"	; ending sequence Sonic
		even
Nem_TryAgain:	binclude	"_binary-files/artnem/tryagain.bin"	; ending "try again" screen
		even
Nem_EndEggman:	binclude	"_binary-files/artnem/xxxend.bin"	; unused boss sequence on ending
		even
Kos_EndFlowers:	binclude	"_binary-files/artkos/flowers.bin"	; ending sequence animated flowers
		even
Nem_EndFlower:	binclude	"_binary-files/artnem/endflowe.bin"	; ending sequence flowers
		even
Nem_CreditText:	binclude	"_binary-files/artnem/credits.bin"	; credits alphabet
		even
Nem_EndStH:	binclude	"_binary-files/artnem/endtext.bin"	; ending sequence "Sonic the Hedgehog" text
		even
; ---------------------------------------------------------------------------
; Collision data
; ---------------------------------------------------------------------------
AngleMap:	binclude	"_level-data/collision/anglemap.bin"	; floor angle map
		even
CollArray1:	binclude	"_level-data/collision/carray_n.bin"	; normal collision array
		even
CollArray2:	binclude	"_level-data/collision/carray_r.bin"	; rotated collision array
		even
Col_GHZ_1:	binclude	"_level-data/collision/ghz1.bin"	; GHZ index 1
		even
Col_GHZ_2:	binclude	"_level-data/collision/ghz2.bin"	; GHZ index 2
		even
Col_LZ_1:	binclude	"_level-data/collision/lz1.bin"		; LZ index 1
		even
Col_LZ_2:	binclude	"_level-data/collision/lz2.bin"		; LZ index 2
		even
Col_MZ_1:	binclude	"_level-data/collision/mz1.bin"		; MZ index 1
		even
Col_MZ_2:	binclude	"_level-data/collision/mz2.bin"		; MZ index 2
		even
Col_SLZ_1:	binclude	"_level-data/collision/slz1.bin"	; SLZ index 1
		even
Col_SLZ_2:	binclude	"_level-data/collision/slz2.bin"	; SLZ index 2
		even
Col_SYZ_1:	binclude	"_level-data/collision/syz1.bin"	; SYZ index 1
		even
Col_SYZ_2:	binclude	"_level-data/collision/syz2.bin"	; SYZ index 2
		even
Col_SBZ_1:	binclude	"_level-data/collision/sbz1.bin"	; SBZ index 1
		even
Col_SBZ_2:	binclude	"_level-data/collision/sbz2.bin"	; SBZ index 2
		even
; ---------------------------------------------------------------------------
; Special layouts
; ---------------------------------------------------------------------------
SS_1:		binclude	"_sslayout/1.bin"
		even
SS_2:		binclude	"_sslayout/2.bin"
		even
SS_3:		binclude	"_sslayout/3.bin"
		even
SS_4:		binclude	"_sslayout/4.bin"
		even
SS_5:		binclude	"_sslayout/5.bin"
		even
SS_6:		binclude	"_sslayout/6.bin"
		even
; ---------------------------------------------------------------------------
; Animated uncompressed graphics
; ---------------------------------------------------------------------------
Art_GhzWater:	binclude	"_binary-files/artunc/ghzwater.bin"	; GHZ waterfall
		even
Art_GhzFlower1:	binclude	"_binary-files/artunc/ghzflowl.bin"	; GHZ large flower
		even
Art_GhzFlower2:	binclude	"_binary-files/artunc/ghzflows.bin"	; GHZ small flower
		even
Art_MzLava1:	binclude	"_binary-files/artunc/mzlava1.bin"	; MZ lava surface
		even
Art_MzLava2:	binclude	"_binary-files/artunc/mzlava2.bin"	; MZ lava
		even
Art_MzTorch:	binclude	"_binary-files/artunc/mztorch.bin"	; MZ torch in background
		even
Art_SbzSmoke:	binclude	"_binary-files/artunc/sbzsmoke.bin"	; SBZ smoke in background
		even
...
Level_GHZ1:	binclude	"_level-data/level-layout/ghz1.bin"
		even
byte_68D70:	dc.b 0,	0, 0, 0
Level_GHZ2:	binclude	"_level-data/level-layout/ghz2.bin"
		even
byte_68E3C:	dc.b 0,	0, 0, 0
Level_GHZ3:	binclude	"_level-data/level-layout/ghz3.bin"
		even
Level_GHZbg:	binclude	"_level-data/level-layout/ghzbg.bin"
		even
byte_68F84:	dc.b 0,	0, 0, 0
byte_68F88:	dc.b 0,	0, 0, 0

Level_LZ1:	binclude	"_level-data/level-layout/lz1.bin"
		even
Level_LZbg:	binclude	"_level-data/level-layout/lzbg.bin"
		even
byte_69190:	dc.b 0,	0, 0, 0
Level_LZ2:	binclude	"_level-data/level-layout/lz2.bin"
		even
byte_6922E:	dc.b 0,	0, 0, 0
Level_LZ3:	binclude	"_level-data/level-layout/lz3.bin"
		even
Level_LZ3_WALL:	binclude	"_level-data/level-layout/lz3_wall.bin"	; MJ: layout with LZ's wall change (When the switch is pressed) data is not in ram anymore,
		even				; and altering values in rom is prohibited, so a new layout is loaded in its place.
byte_6934C:	dc.b 0,	0, 0, 0
Level_SBZ3:	binclude	"_level-data/level-layout/sbz3.bin"
		even
byte_6940A:	dc.b 0,	0, 0, 0

Level_MZ1:	binclude	"_level-data/level-layout/mz1.bin"
		even
Level_MZ1bg:	binclude	"_level-data/level-layout/mz1bg.bin"
		even
Level_MZ2:	binclude	"_level-data/level-layout/mz2.bin"
		even
Level_MZ2bg:	binclude	"_level-data/level-layout/mz2bg.bin"
		even
byte_6965C:	dc.b 0,	0, 0, 0
Level_MZ3:	binclude	"_level-data/level-layout/mz3.bin"
		even
Level_MZ3bg:	binclude	"_level-data/level-layout/mz3bg.bin"
		even
byte_697E6:	dc.b 0,	0, 0, 0
byte_697EA:	dc.b 0,	0, 0, 0

Level_SLZ1:	binclude	"_level-data/level-layout/slz1.bin"
		even
Level_SLZbg:	binclude	"_level-data/level-layout/slzbg.bin"
		even
Level_SLZ2:	binclude	"_level-data/level-layout/slz2.bin"
		even
Level_SLZ3:	binclude	"_level-data/level-layout/slz3.bin"
		even
byte_69B84:	dc.b 0,	0, 0, 0

Level_SYZ1:	binclude	"_level-data/level-layout/syz1.bin"
		even
Level_SYZbg:	binclude	"_level-data/level-layout/syzbg.bin"
		even
byte_69C7E:	dc.b 0,	0, 0, 0
Level_SYZ2:	binclude	"_level-data/level-layout/syz2.bin"
		even
byte_69D86:	dc.b 0,	0, 0, 0
Level_SYZ3:	binclude	"_level-data/level-layout/syz3.bin"
		even
byte_69EE4:	dc.b 0,	0, 0, 0
byte_69EE8:	dc.b 0,	0, 0, 0

Level_SBZ1:	binclude	"_level-data/level-layout/sbz1.bin"
		even
Level_SBZ1bg:	binclude	"_level-data/level-layout/sbz1bg.bin"
		even
Level_SBZ2:	binclude	"_level-data/level-layout/sbz2.bin"
		even
Level_SBZ2bg:	binclude	"_level-data/level-layout/sbz2bg.bin"
		even
byte_6A2F8:	dc.b 0,	0, 0, 0
byte_6A2FC:	dc.b 0,	0, 0, 0
Level_End:	binclude	"_level-data/level-layout/ending.bin"
		even
...
; ---------------------------------------------------------------------------
Art_BigRing:	binclude	"_binary-files/artunc/bigring.bin"
		even
...
ObjPos_Index:	dc.w ObjPos_GHZ1-ObjPos_Index, ObjPos_Null-ObjPos_Index
		...
		dc.w ObjPos_SBZ1pf1-ObjPos_Index, ObjPos_SBZ1pf2-ObjPos_Index
		dc.b $FF, $FF, 0, 0, 0,	0
ObjPos_GHZ1:	binclude	"_level-data/object-positions/ghz1.bin"
		even
ObjPos_GHZ2:	binclude	"_level-data/object-positions/ghz2.bin"
		even
ObjPos_GHZ3:	binclude	"_level-data/object-positions/ghz3.bin"
		even
ObjPos_LZ1:	binclude	"_level-data/object-positions/lz1.bin"
		even
ObjPos_LZ2:	binclude	"_level-data/object-positions/lz2.bin"
		even
ObjPos_LZ3:	binclude	"_level-data/object-positions/lz3.bin"
		even
ObjPos_SBZ3:	binclude	"_level-data/object-positions/sbz3.bin"
		even
ObjPos_LZ1pf1:	binclude	"_level-data/object-positions/lz1pf1.bin"
		even
ObjPos_LZ1pf2:	binclude	"_level-data/object-positions/lz1pf2.bin"
		even
ObjPos_LZ2pf1:	binclude	"_level-data/object-positions/lz2pf1.bin"
		even
ObjPos_LZ2pf2:	binclude	"_level-data/object-positions/lz2pf2.bin"
		even
ObjPos_LZ3pf1:	binclude	"_level-data/object-positions/lz3pf1.bin"
		even
ObjPos_LZ3pf2:	binclude	"_level-data/object-positions/lz3pf2.bin"
		even
ObjPos_MZ1:	binclude	"_level-data/object-positions/mz1.bin"
		even
ObjPos_MZ2:	binclude	"_level-data/object-positions/mz2.bin"
		even
ObjPos_MZ3:	binclude	"_level-data/object-positions/mz3.bin"
		even
ObjPos_SLZ1:	binclude	"_level-data/object-positions/slz1.bin"
		even
ObjPos_SLZ2:	binclude	"_level-data/object-positions/slz2.bin"
		even
ObjPos_SLZ3:	binclude	"_level-data/object-positions/slz3.bin"
		even
ObjPos_SYZ1:	binclude	"_level-data/object-positions/syz1.bin"
		even
ObjPos_SYZ2:	binclude	"_level-data/object-positions/syz2.bin"
		even
ObjPos_SYZ3:	binclude	"_level-data/object-positions/syz3.bin"
		even
ObjPos_SBZ1:	binclude	"_level-data/object-positions/sbz1.bin"
		even
ObjPos_SBZ2:	binclude	"_level-data/object-positions/sbz2.bin"
		even
ObjPos_FZ:	binclude	"_level-data/object-positions/fz.bin"
		even
ObjPos_SBZ1pf1:	binclude	"_level-data/object-positions/sbz1pf1.bin"
		even
ObjPos_SBZ1pf2:	binclude	"_level-data/object-positions/sbz1pf2.bin"
		even
ObjPos_SBZ1pf3:	binclude	"_level-data/object-positions/sbz1pf3.bin"
		even
ObjPos_SBZ1pf4:	binclude	"_level-data/object-positions/sbz1pf4.bin"
		even
ObjPos_SBZ1pf5:	binclude	"_level-data/object-positions/sbz1pf5.bin"
		even
ObjPos_SBZ1pf6:	binclude	"_level-data/object-positions/sbz1pf6.bin"
		even
ObjPos_End:	binclude	"_level-data/object-positions/ending.bin"
		even
...
; ---------------------------------------------------------------------------
   ...
   include   "_includes-ASM/ErrorHandler.asm"
