...
namespace S1ObjectDefinitions.Common
{
	class InvisibleBlock : ObjectDefinition
	{
		...
		{
			byte[] artfile = ObjectHelper.OpenArtFile("../_binary-files/artnem/monitors.bin", CompressionType.Nemesis);
			img = ObjectHelper.MapASMToBmp(artfile, "../_mappings/obj71.asm", 0, 0);
		}
