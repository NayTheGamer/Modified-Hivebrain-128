...
namespace S1ObjectDefinitions.GHZ
{
	class Bridge : ObjectDefinition
	{
		...
		{
			byte[] artfile = ObjectHelper.OpenArtFile("../_binary-files/artnem/ghzbridg.bin", CompressionType.Nemesis);
			img = ObjectHelper.MapASMToBmp(artfile, "../_mappings/obj11.asm", 0, 2);
		}
