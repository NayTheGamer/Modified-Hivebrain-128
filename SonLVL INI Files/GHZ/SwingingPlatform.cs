...
namespace S1ObjectDefinitions.GHZ
{
	class SwingingPlatform : ObjectDefinition
	{
		...
		{
			imgwreckingball = ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../_binary-files/artnem/ghzball.bin", CompressionType.Nemesis), "../_mappings/obj48.asm", 1, 2);
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../_binary-files/artnem/ghzswing.bin", CompressionType.Nemesis), "../_mappings/obj15ghz.asm", labels[i], i == 1 ? 0 : 2));
		}
